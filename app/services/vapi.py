"""
VAPI client — outbound AI phone calls
https://docs.vapi.ai
"""
import httpx
...
async def start_consent_call(
    ...
    system = (
        ...
        f"The match: {match_name or 'someone'} is a {match_role} in {match_location} — {match_summary}.\n\n"
    ...
    payload = {
        "assistant": {
            ...
            "analysisPlan": {
                "structuredDataPrompt": "Did the user consent to connecting with their match? Set consented to true if yes, false if no.",
